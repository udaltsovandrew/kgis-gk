define(["./js/app/domain/carto-compiled.js"], function (carto) {
  "use strict";
  ...
  function exportMap(paperSize, imageFormat) {
    ...
    carto.exportMap({ url: config.print.url, paperSize: paperSize, imageFormat: imageFormat }).then(function (result) {
...
//# sourceMappingURL=export-compiled.js.map

//# sourceMappingURL=export-compiled-compiled.js.map