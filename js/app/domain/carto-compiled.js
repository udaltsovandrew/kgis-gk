...
define(["esri/geometry/Extent", "esri/geometry/Point", "esri/geometry/Polygon", "esri/geometry/Polyline", "esri/SpatialReference", "esri/Color", "esri/symbols/SimpleMarkerSymbol", "esri/symbols/PictureMarkerSymbol", "esri/symbols/SimpleLineSymbol", "esri/symbols/SimpleFillSymbol", "esri/renderers/UniqueValueRenderer", "esri/renderers/ScaleDependentRenderer", "esri/graphic", "esri/geometry/geometryEngine", "esri/geometry/webMercatorUtils", "esri/tasks/PrintTask", "esri/tasks/PrintParameters", "esri/tasks/PrintTemplate", "esri/map"], function (Extent, Point, Polygon, Polyline, SpatialReference, Color, SimpleMarkerSymbol, PictureMarkerSymbol, SimpleLineSymbol, SimpleFillSymbol, UniqueValueRenderer, ScaleDependentRenderer, Graphic, geometryEngine, webMercatorUtils, PrintTask, PrintParameters, PrintTemplate, Map) {
    ...
    function exportFeaturesToKML(elementName, className) {
        ...
        return db[className].getByArray(ids).then(function (featureSet) {
...
//# sourceMappingURL=carto-compiled.js.map