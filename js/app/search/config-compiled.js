    ...
    return {
        sources: [{
            ...
            divTemplate: function (data) {
                ...
                return "<div class='search-result' id='" + divId + "' data-id='" + objectId + "'data-className='" + className + "'>" + "<div class='search-result-id' id='id-" + divId + "'>" + aliasClassName + " ID: " + objectId + "</div>" + "<div class='search-result-name' id='name-" + divId + "'><strong>" + localName + " (" + aliasName + ")</strong></div>" + "<div id='description-" + divId + "'>" + description + "</div>" + "<div class='links-container' id='links-container-" + divId + "'></div>" + "<div class='docs-container' id='docs-container-" + divId + "'></div></div>";
            },
            ...
            divTemplate: function (data) {
                ...
                return "<div class='search-result' id='" + divId + "' data-id='" + objectId + "'data-className='" + className + "'>" + "<div class='search-result-id' id='id-" + divId + "'>" + aliasClassName + " ID: " + objectId + "</div>" + "<div class='search-result-name' id='name-" + divId + "'><strong>" + lastName + " " + firstName + " " + mName + "</strong></div>" + "<div id='description-" + divId + "'>" + craft + " в " + workPlace + "</div>" + "<div class='links-container' id='links-container-" + divId + "'></div>" + "<div class='docs-container' id='docs-container-" + divId + "'></div></div>";
            },
